...
void main() {
  group('Basic Accessibility Tests', () {
    ...
    test('AccessibilitySettings should adjust animation duration for reduced motion', () {
    ...
    test('AccessibilitySettings should adjust text style for bold text preference', () {
    ...
    testWidgets('AccessibleElevatedButton should meet minimum touch target size', (tester) async {
    ...
    testWidgets('AccessibleTextButton should have proper semantics', (tester) async {
    ...
    testWidgets('AccessibleIconButton should have minimum touch target', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
