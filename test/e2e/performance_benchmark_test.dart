  ...
  group('Performance Benchmark E2E Tests', () {
    testWidgets('App startup performance benchmark', (tester) async {
      ...
      expect(
        ...
        lessThan(3000),
        reason:
            'App startup should complete within 3 seconds, took ${startupTime}ms',
      );
      ...
      expect(
        ...
        lessThan(500),
        reason:
            'First frame should render within 500ms, took ${firstFrameTime}ms',
      );
      ...
      expect(
        ...
        lessThan(100),
        reason:
            'Initial memory usage should be under 100MB, was ${initialMemory}MB',
      );
    });
    ...
    testWidgets('Navigation performance benchmark', (tester) async {
      ...
      for (final (tabKey, tabName) in tabs) {
        ...
        expect(
          ...
          lessThan(300),
          reason:
              '$tabName tab navigation should complete within 300ms, took ${navigationTime}ms',
        );
      }
      ...
      expect(
        ...
        lessThan(200),
        reason:
            'Quest creation screen should open within 200ms, took ${questCreationTime}ms',
      );
      ...
      expect(
        ...
        lessThan(150),
        reason:
            'Back navigation should complete within 150ms, took ${backNavigationTime}ms',
      );
    ...
    testWidgets('Large dataset rendering performance', (tester) async {
      await tester.pumpWidget(
        app.MinQApp(skipOnboarding: true, mockData: MockData.largeDataset()),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        ...
        lessThan(1000),
        reason:
            'Large quest list (1000+ items) should render within 1s, took ${largeListTime}ms',
      );
      ...
      expect(
        ...
        lessThan(500),
        reason:
            'Fast scroll should complete within 500ms, took ${scrollTime}ms',
      );
      ...
      expect(
        ...
        lessThan(300),
        reason:
            'Search in large dataset should complete within 300ms, took ${searchTime}ms',
      );
    ...
    testWidgets('Memory usage under load', (tester) async {
      ...
      for (int i = 0; i < 50; i++) {
        ...
        if (i % 10 == 0) {
          ...
          expect(
            ...
            lessThan(200),
            reason:
                'Memory usage should stay under 200MB, was ${currentMemory}MB after ${i + 1} quests',
          );
        }
      }
      ...
      print(
        '💾 Final memory: ${finalMemory}MB (increase: ${memoryIncrease}MB)',
      );
      ...
      final navigationMemoryIncrease =
          navigationMemoryEnd - navigationMemoryStart;

      print(
        '💾 Memory after navigation test: ${navigationMemoryEnd}MB (increase: ${navigationMemoryIncrease}MB)',
      );

      // Navigation should not cause significant memory leaks (under 10MB)
      expect(
        navigationMemoryIncrease,
        lessThan(10),
        reason:
            'Navigation memory increase should be under 10MB, was ${navigationMemoryIncrease}MB',
      );
    });
    ...
    testWidgets('Database performance benchmark', (tester) async {
      ...
      expect(
        ...
        lessThan(30000),
        reason:
            'Bulk insert of 100 quests should complete within 30s, took ${bulkInsertTime}ms',
      );
      ...
      await tester.tap(
        find.byKey(const Key('calculate_advanced_stats_button')),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        ...
        lessThan(1000),
        reason:
            'Complex statistics query should complete within 1s, took ${queryTime}ms',
      );
