...
void main() {
  group('VirtualizedList', () {
    ...
    testWidgets('should display empty widget when no items', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('should display custom empty widget', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should add separators when specified', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle end reached callback', (
      WidgetTester tester,
    ) async {
  ...
  group('QuestVirtualizedList', () {
          ...
          home: Scaffold(
            body: QuestVirtualizedList(
              ...
              itemBuilder: (context, quest, index) {
                return ListTile(title: Text(quest['title'] as String));
              },
            ),
          ),
        ),
    ...
    testWidgets('should display empty state for quests', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('should display loading widget when loading', (
      WidgetTester tester,
    ) async {
      final quests = [
        {'id': '1', 'title': 'Quest 1'},
