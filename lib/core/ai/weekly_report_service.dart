...
''';
  ...
  TrendDirection _determineTrendDirection(WeeklyData data) {
    final completionRate = data.totalCompletions / (data.totalHabits * 7); // ignore: unused_local_variable
...
''';
  ...
  double _calculateMoodCompletionCorrelation(WeeklyData data) {
    ...
    final moodScores = data.moods.map((m) => m.score).toList(); // ignore: unused_local_variable
