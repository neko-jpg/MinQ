...
class BiometricService {
  ...
  Future<bool> enableBiometric() async {
    try {
      ...
      if (!isAvailable) {
        throw const AuthenticationException('Biometric authentication not available');
      }
      ...
      throw const AuthenticationException('Failed to enable biometric authentication');
    }
  }
  ...
  Future<bool> authenticateWithBiometric() async {
    try {
      ...
      if (!isEnabled) {
        throw const AuthenticationException('Biometric authentication not enabled');
      }
  ...
  Future<bool> authenticateWithPIN(String pin) async {
    try {
      ...
      if (await _isLockedOut()) {
        throw const AuthenticationException('Account temporarily locked due to too many failed attempts');
      }
    ...
    try {
      ...
      if (biometricEnabled) {
        try {
          ...
          debugPrint('Biometric authentication failed, falling back to PIN: $e');
        }
      }
...
class AuthenticationResult {
  ...
  factory AuthenticationResult.lockedOut(DateTime? lockoutEnd) =>
      AuthenticationResult._(status: AuthStatus.lockedOut, lockoutEnd: lockoutEnd);
