...
class _ParticleSystemState extends State<ParticleSystem>
  ...
  Particle _createParticle() {
    ...
    final size = widget.config.minSize + 
                 _random.nextDouble() * (widget.config.maxSize - widget.config.minSize);
    final life = widget.config.minLife + 
...
class ParticlePainter extends CustomPainter {
  ...
  void _initializeParticlePosition(Particle particle, double centerX, double centerY) {
  ...
  void _drawHeart(Canvas canvas, Offset center, double size, Paint paint) {
    ...
    // 左の曲線
    path.cubicTo(
      center.dx - heartSize * 0.5, center.dy - heartSize * 0.3,
      center.dx - heartSize, center.dy - heartSize * 0.1,
      center.dx - heartSize * 0.5, center.dy + heartSize * 0.1,
    );
