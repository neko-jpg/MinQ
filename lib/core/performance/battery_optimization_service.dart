...
class BatteryOptimizationService {
  ...
  void _scheduleBackgroundTasks() {
    ...
    final interval = _isLowPowerMode 
        ? _reducedSyncInterval 
  ...
  BatteryOptimizationLevel _getOptimizationLevel() {
    ...
    if (_batteryLevel <= _lowBatteryThreshold) return BatteryOptimizationLevel.moderate;
...
typedef BatteryOptimizationCallback = void Function(BatteryEvent event, BatteryInfo info);