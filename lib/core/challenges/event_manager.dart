...
class EventManager {
  ...
  Future<void> createEvent(Event event) async {
    try {
      ...
      MinqLogger.info("Event '${event.name}' created successfully.");
    } catch (e) {
      MinqLogger.error('Error creating event: $e');
    }
  }
  ...
  Future<List<Event>> getActiveEvents() async {
    try {
      ...
      MinqLogger.error('Error fetching active events: $e');
      return [];
    }
  }
  ...
  Future<void> registerForEvent({
    ...
    try {
      ...
      MinqLogger.info('User $userId registered for event $eventId.');
    } catch (e) {
      MinqLogger.error('Error registering user for event: $e');
    }
  }
}
