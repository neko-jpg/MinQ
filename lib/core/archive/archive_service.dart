...
class ArchiveService {
  ...
  Future<void> archiveQuest(String userId, String questId) async {
    try {
      ...
      AppLogger().logJson('Quest archived', {'questId': questId});
    } catch (e, stack) {
  ...
  Future<void> unarchiveQuest(String userId, String questId) async {
    try {
      ...
      AppLogger().logJson('Quest unarchived', {'questId': questId});
    } catch (e, stack) {
  ...
  Future<void> deleteArchivedQuest(String userId, String questId) async {
    try {
      ...
      AppLogger().logJson('Archived quest deleted', {'questId': questId});
    } catch (e, stack) {
      AppLogger().error(
