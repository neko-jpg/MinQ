...
class DatabaseMaintenanceService {
  ...
  static DatabaseMaintenanceService get instance =>
      _instance ??= DatabaseMaintenanceService._();
  ...
  void startPeriodicMaintenance({
    ...
    developer.log(
      'Database maintenance service started (interval: ${interval.inHours}h)',
    );
  }
  ...
  Future<MaintenanceReport> performMaintenance({
    ...
    try {
      ...
      developer.log(
        'Database maintenance completed in ${stopwatch.elapsedMilliseconds}ms',
      );
  ...
  Future<void> _performHealthCheck(MaintenanceReport report) async {
    try {
      final healthStatus =
          await DatabaseLifecycleManager.instance.performHealthCheck();
  ...
  Future<MaintenanceReport> performMaintenance({
    ...
    try {
      ...
      if (cleanupOldLogs && questLogRepository != null) {
        ...
        developer.log(
          'Would cleanup logs older than ${logRetention.inDays} days',
        );
