...
class DatabaseLifecycleManager {
  ...
  static DatabaseLifecycleManager get instance => _instance ??= DatabaseLifecycleManager._();
...
typedef DatabaseProgressCallback = void Function(String message, double progress);

/// Enhanced Isar service with lifecycle management
class EnhancedIsarService {
  final DatabaseLifecycleManager _lifecycleManager = DatabaseLifecycleManager.instance;
