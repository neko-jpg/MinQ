...
abstract class $RewardCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String description, int cost, String type});
}
...
class _$RewardImpl implements _Reward {
  ...
  @override
  String toString() {
    return 'Reward(id: $id, name: $name, description: $description, cost: $cost, type: $type)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, cost, type);
...
abstract class _Reward implements Reward {
  const factory _Reward(
      ...
      required final String type}) = _$RewardImpl;
