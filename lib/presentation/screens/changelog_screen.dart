...
class ChangelogScreen extends ConsumerWidget {
  ...
  Widget _buildSection(
    ...
    return Column(
      ...
      children: [
        Text(title, style: tokens.typeScale.h2),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          Text(
            ...
            style: tokens.typeScale.caption.copyWith(color: Colors.grey),
          ),
          if (item.description != null) ...[
            SizedBox(height: tokens.spacing(2)),
            Text(item.description!, style: tokens.typeScale.bodyMedium),
          ],
            ...
            ...item.changes.map(
              (change) => Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('• ', style: tokens.typeScale.bodyMedium),
                    Expanded(
                      child: Text(change, style: tokens.typeScale.bodyMedium),
                    ),
                  ],
                ),
              ),
