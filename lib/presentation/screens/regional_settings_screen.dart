...
class RegionalSettingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RegionalSettingsScreen> createState() => _RegionalSettingsScreenState();
}

class _RegionalSettingsScreenState extends ConsumerState<RegionalSettingsScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildRegionalInfoCard(Locale locale, AppLocalizations l10n, ThemeData theme, MinqTheme tokens) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Currency', '${config.currency} (${config.currencySymbol})'),
            _buildInfoRow('Date Format', config.dateFormat),
            _buildInfoRow('Time Format', config.timeFormat),
            _buildInfoRow('Week Starts', _getWeekStartName(config.firstDayOfWeek)),
            ...
            if (holidays.isNotEmpty) ...[
              ...
              ...holidays.take(3).map((holiday) => Padding(
  ...
  Widget _buildCulturalPreferencesCard(Locale locale, AppLocalizations l10n, ThemeData theme, MinqTheme tokens) {
    final config = RegionalService.getRegionalConfig(locale);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: MinqTokens.spacing(2)),
                _buildColorSwatch('Celebration', config.culturalColors.celebration),
                SizedBox(width: MinqTokens.spacing(2)),
                _buildColorSwatch('Prosperity', config.culturalColors.prosperity),
              ],
            ),
            ...
            if (config.culturalNumbers.lucky.isNotEmpty) ...[
              _buildInfoRow('Lucky Numbers', config.culturalNumbers.lucky.join(', ')),
            ],
            if (config.culturalNumbers.unlucky.isNotEmpty) ...[
              _buildInfoRow('Unlucky Numbers', config.culturalNumbers.unlucky.join(', ')),
            ],
  ...
  Widget _buildTimezoneCard(Locale locale, AppLocalizations l10n, ThemeData theme, MinqTheme tokens) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Current Time', TimezoneService.formatWithTimezone(currentTime)),
            _buildInfoRow('UTC Offset', _formatOffset(currentTime.timeZoneOffset)),
            _buildInfoRow('Daylight Saving', TimezoneService.isDaylightSavingTime(currentTime) ? 'Active' : 'Inactive'),
  ...
  Widget _buildFormatExamplesCard(Locale locale, AppLocalizations l10n, ThemeData theme, MinqTheme tokens) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Currency', RegionalService.formatCurrency(sampleAmount, locale)),
            _buildInfoRow('Number', CulturalAdaptationService.formatNumber(sampleNumber, locale)),
            _buildInfoRow('Greeting', CulturalAdaptationService.getTimeBasedGreeting(now, locale)),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      textAlign: CulturalAdaptationService.getTextAlignment(locale),
                      style: MinqTokens.bodySmall.copyWith(
                        color: MinqTokens.textSecondary,
                      ),
                    ),
