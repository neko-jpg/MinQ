...
class CategoryBreakdownWidget extends ConsumerWidget {
  ...
  Widget _buildPieChart(BuildContext context, Map<String, double> categoryData) {
  ...
  List<PieChartSectionData> _createPieChartSections(Map<String, double> categoryData) {
    final colors = [
      Colors.blue,
      Colors.green,
      Colors.orange,
