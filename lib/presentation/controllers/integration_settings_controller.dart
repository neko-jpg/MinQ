...
class _AsyncToggleController extends StateNotifier<AsyncValue<bool>> {
  _AsyncToggleController(this._load, this._persist)
...
final liveActivityToggleProvider =
    StateNotifierProvider<_AsyncToggleController, AsyncValue<bool>>((ref) {
      ...
      return _AsyncToggleController(() => prefs.isLiveActivityEnabled(), (
        value,
      ) async {
...
final wearableSyncToggleProvider =
    StateNotifierProvider<_AsyncToggleController, AsyncValue<bool>>((ref) {
      ...
      return _AsyncToggleController(() => prefs.isWearableSyncEnabled(), (
        value,
      ) async {
        ...
        if (value) {
          ...
          if (userId != null) {
            final quests =
                await ref.read(questRepositoryProvider).getAllQuests();
...
final fitnessSyncToggleProvider =
    StateNotifierProvider<_AsyncToggleController, AsyncValue<bool>>((ref) {
      ...
      return _AsyncToggleController(() => prefs.isFitnessAutoLoggingEnabled(), (
        value,
      ) async {
...
final menuBarTimerToggleProvider =
    StateNotifierProvider<_AsyncToggleController, AsyncValue<bool>>((ref) {
      ...
      return _AsyncToggleController(() => prefs.isMenuBarTimerEnabled(), (
        value,
      ) async {
