...
/// GoRouter縺ｮrefreshListenable縺ｨ縺励※菴ｿ逕ｨ縺吶ｋStream繝ｩ繝・ヱ繝ｼ
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // 譛ｪ隱崎ｨｼ縺ｧ菫晁ｭｷ縺輔ｌ縺溘Ν繝ｼ繝医↓繧｢繧ｯ繧ｻ繧ｹ縺励ｈ縺・→縺励◆蝣ｴ蜷・
      if (!isAuthenticated && !isPublicRoute) {
        return AppRoutes.onboarding;
      }

      // 隱崎ｨｼ貂医∩縺ｧ繝ｭ繧ｰ繧､繝ｳ逕ｻ髱｢縺ｫ繧｢繧ｯ繧ｻ繧ｹ縺励ｈ縺・→縺励◆蝣ｴ蜷・
      if (isAuthenticated && isPublicRoute) {
