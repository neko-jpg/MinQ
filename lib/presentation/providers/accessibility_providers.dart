...
final highContrastProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.highContrast));
});

/// Provider for large text mode
final largeTextProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.largeText));
});

/// Provider for bold text mode
final boldTextProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.boldText));
});

/// Provider for reduce motion mode
final reduceMotionProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.reduceMotion));
});

/// Provider for text scale factor
final textScaleProvider = Provider<double>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.textScale));
});

/// Provider for button scale factor
final buttonScaleProvider = Provider<double>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.buttonScale));
});

/// Provider for screen reader optimization
final screenReaderOptimizedProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.screenReaderOptimized));
});

/// Provider for haptic feedback
final hapticFeedbackProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.hapticFeedback));
});

/// Provider for sound feedback
final soundFeedbackProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.soundFeedback));
});

/// Provider for color blindness mode
final colorBlindnessModeProvider = Provider<ColorBlindnessMode>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.colorBlindnessMode));
});

/// Provider for keyboard navigation
final keyboardNavigationProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.keyboardNavigation));
});

/// Provider for focus indicator
final focusIndicatorProvider = Provider<bool>((ref) {
  return ref.watch(accessibilityServiceProvider.select((settings) => settings.focusIndicator));
});
...
final accessibilitySummaryProvider = Provider<String>((ref) {
  ...
  if (settings.textScale != 1.0) features.add('Text Scale: ${(settings.textScale * 100).round()}%');
  if (settings.buttonScale != 1.0) features.add('Button Scale: ${(settings.buttonScale * 100).round()}%');
...
final effectiveAnimationDurationProvider = Provider.family<Duration, Duration>((ref, baseDuration) {
