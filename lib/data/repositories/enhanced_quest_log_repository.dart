...
class EnhancedQuestLogRepository extends QuestLogRepository
  ...
  Future<List<QuestLog>> getLogsForUser(String uid) {
    return trackOperation(
      'quest_log_get_by_user',
      () => super.getLogsForUser(uid),
    );
  }
  ...
  Future<List<QuestLog>> getLogsForDay(String uid, DateTime day) {
    return trackOperation(
      'quest_log_get_by_day',
      () => super.getLogsForDay(uid, day),
    );
  }
  ...
  Future<int> countLogsForDay(String uid, DateTime day) {
    return trackOperation(
      'quest_log_count_by_day',
      () => super.countLogsForDay(uid, day),
    );
  }
  ...
  Future<int> calculateStreak(String uid) {
    return trackOperation(
      'quest_log_calculate_streak',
      () => super.calculateStreak(uid),
    );
  }
  ...
  Future<int> calculateLongestStreak(String uid) {
    return trackOperation(
      'quest_log_calculate_longest_streak',
      () => super.calculateLongestStreak(uid),
    );
  }
  ...
  Future<Map<DateTime, int>> getHeatmapData(String uid) {
    return trackOperation(
      'quest_log_get_heatmap',
      () => super.getHeatmapData(uid),
    );
  }
  ...
  Future<bool> hasCompletedDailyGoal(
    ...
    return trackOperation(
      'quest_log_check_daily_goal',
      () =>
          super.hasCompletedDailyGoal(uid, day: day, targetCount: targetCount),
    );
  }
  ...
  Future<bool> hasUnsyncedLogs(String uid) {
    return trackOperation(
      'quest_log_check_unsynced',
      () => super.hasUnsyncedLogs(uid),
    );
  }
  ...
  Future<void> markLogsAsSynced(List<int> ids) {
    return trackOperation(
      'quest_log_mark_synced',
      () => super.markLogsAsSynced(ids),
    );
  }
  ...
  Future<List<QuestLog>> getLogsInRange(
    ...
    return trackOperation('quest_log_get_range', () async {
      ...
      if (offset > 0) {
        query =
            query.offset(offset)
                as QueryBuilder<QuestLog, QuestLog, QAfterSortBy>;
      }
